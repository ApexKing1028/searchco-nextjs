...
const SignupPage = () => {
    ...
    useEffect(() => {
        auth.onAuthStateChanged((user) => {
            if (user) router.push("/userid-input");
        });
    }, []);

    const handleSignupGoogle = async (e: any) => {
        e.preventDefault()

        try {
            await signInWithGoogle()
            router.push('/userid-input')
        } catch (error) {
            console.error(error);
        }
    }
                        ...
                        <div className="w-full px-4">
                            <div className="shadow-three mx-auto max-w-[500px] rounded bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
                                ...
                                <form>
                                    ...
                                    <div className="mb-6">
                                        <button className="gap-2 shadow-submit dark:shadow-submit-dark flex w-full items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white duration-300 hover:bg-primary/90" onClick={handleSignupWithEmail}>
                                            {authing && <Oval
                                                visible={true}
                                                height="20"
                                                width="30"
