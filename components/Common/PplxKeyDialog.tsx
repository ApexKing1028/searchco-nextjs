...
export const PplxKeyDialog: FC<OpenaiKeyDialogProps> = ({ open, onClose }) => {
    ...
    const handleSaveProfileInformation = async () => {
        if (key?.length <= 0) {
            toast.warn("Please input perplexity key.");
            return;
        }
        try {
            setIsSaving(true);
                    ...
                    <div className="fixed inset-0 z-10 overflow-hidden">
                        <div className="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                            ...
                            <div
                                ...
                                role="dialog"
                            >
                                <div className="text-3xl font-bold text-black dark:text-neutral-200">Perplexity Key Adding</div>
                                ...
                                <input
                                    ...
                                    placeholder="Please input perplexity key here."
                                    value={key}
