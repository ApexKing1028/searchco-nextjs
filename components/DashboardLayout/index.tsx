...
import { SharedPromptViewDialog } from '@/components/Common/PromptBar/components/SharedPromptViewDialog';
import { SharedPromptDialog } from '../Common/PromptBar/components/SharedPromptDialog';
import { PromptModal } from '../Common/PromptBar/components/PromptModal';
    ...
    return <>
...

        {
            !isFullScreen && <aside id="logo-sidebar" className={`sidebar-scrollbar fixed top-0 left-0 z-40 w-64 h-screen transition-transform bg-[#f8f8f8] border-r border-gray-200 sm:translate-x-0 dark:bg-[#1d2430] dark:border-gray-700  ${isOpen ? 'translate-x-0' : '-translate-x-full'}`} aria-label="Sidebar">
                <div className="h-full px-1 pb-4 overflow-y-auto bg-[#f8f8f8]] flex flex-col justify-between sidebar-scrollbar mt-[80px]">
                    <div>
        ...
        <div className={`${isFullScreen ? "sm:ml-0" : "sm:ml-64 pt-[79px]"} bg-[#f8f8f8] min-h-screen dark:bg-[#1d2430] relative`}>
            <div className='w-full h-full' >
                {children}
            </div>
        </div>

        <div className="hidden sm:flex text-[12px] fixed bottom-[0px] w-full justify-center">
            <div
        ...
        <PromptLibraryDialog
            ...
            onClose={() => {
                homeDispatch({ field: "isPromptLibraryDialogOpen", value: false })
            }}
        />
        ...
        <SharedPromptViewDialog
            ...
            onClose={() => {
                homeDispatch({ field: "isSharedPromptViewDialogOpen", value: false });
            }}
        />
    </>
}
