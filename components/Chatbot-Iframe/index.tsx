                        ...
                        <div className="flex border-t px-4 py-3 border-[#e4e4e7]">
                            <div className="flex w-full items-center leading-none">
                                <textarea
                                    ...
                                    rows={2}
                                    tabIndex={0}
                                    className="mr-3 message-scrollbar max-h-36 min-h-[48px] text-black w-full resize-none bg-transparent pr-3 leading-[24px] focus:outline-none focus:ring-0 focus-visible:ring-0 group-[.cb-dark]:text-white group-[.cb-light]:text-black"
                                    placeholder="Message..."
