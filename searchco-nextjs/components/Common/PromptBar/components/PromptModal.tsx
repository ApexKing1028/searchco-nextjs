...
export const PromptModal: FC<Props> = ({ prompt, onClose, onUpdatePrompt, open }) => {
  ...
  const handleUse = () => {
    // homeDispatch({ field: 'prompt', value: content });
    // homeDispatch({ field: 'isPromptDialogOpen', value: false })
  }
        ...
        <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            ...
            <div className='w-full flex justify-between gap-2'>
              <button
                type="button"
                className="mt-[20px] w-[50%] px-[20px] rounded-md border-[1px] py-[5px] flex justify-center items-center gap-2 border-gray-500 dark:border-gray-600 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 hover:dark:bg-gray-700"
                onClick={handleSave}
              >
                {isSaving && <Oval
                  visible={true}
